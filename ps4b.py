...
def compPlayHand(hand, wordList, n):
    ...
    while 1:
        ...
        print '"'+str(bestWord)+'"'+ 'earned '+str(getWordScore(bestWord, n))+' points. Total: '+str(totalScore)+' points'
        print 
    ...
    while 1:
        ...
        if userInput=='n':
            ...
            while 1:
                ...
                inputYourselfOrComputer = raw_input()
                print

                if inputYourselfOrComputer=='u':                    
                    hand = dealHand(n)
                    lastHand = hand.copy()
                    lastHand_flag = True
                    ...
                    print
                    break
                elif inputYourselfOrComputer=='c':
                    hand = dealHand(n)
                    lastHand = hand.copy()
                    lastHand_flag = True
            ...
            if lastHand_flag==False:
                print 'You have not played a hand yet. Please play a new hand first!'
                continue
            else:
                while 1: 
                    print 'Enter u to have yourself play, c to have the computer play: ',
                    inputYouselfOrComputer = raw_input()
                    if inputYouselfOrComputer=='u':                    
                        playHand(lastHand, wordList, n)
                        print
                        break
                    elif inputYouselfOrComputer=='c':
